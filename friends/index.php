...
$str = "python ../python_files/get_user_list.py";
$info = shell_exec($str);
//$info = "sid yadav 2021";
$words = explode(",", $info);
...
?>
  ...
  <div class="w3-container">
    ...
    <div class="w3-card-4 w3-grey" style="width:30%;margin-top:0%;margin-left:0%">
  ...
  <label style="background-color:grey;color:white;font-size:45px;border-radius:15px;width:90%;">Users On the social media </label>
  </div>
  ...
  ?>
    ...
    <div class="w3-card-4" style="width:30%;margin-top:<?php if(($i%4)!=0) echo "-43"; ?>%;margin-left:<?php echo ($i%4)*35; ?>%;">
